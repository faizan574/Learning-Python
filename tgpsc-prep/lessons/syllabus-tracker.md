# TGPSC Syllabus Coverage Tracker

The daily Routine reads this file before writing each lesson, picks the next unticked topic
per subject, and ticks it (with the day number) after covering it. Nothing gets skipped;
...
- [x] DPSP (Art 36-51) & Fundamental Duties (51A) — Day 9 ✓✓ Day 32 (revision)
...
- [x] Central schemes active in Telangana (PM-KISAN, Ayushman overlap, comparisons) — Day 14 ✓✓ Day 28 (revision) ✓✓ Day 42 (revision)
...
- [x] Kakatiyas: administration, economy, society, architecture — Day 6 ✓✓ Day 31 (revision)
...
- [x] Area Focus: Mahabubnagar/Palamuru (geology + culture) — Day 11 ✓✓ Day 31 (revision)
...
- [x] Environmental issues: Musi pollution, urban lakes, uranium/Nallamala — Day 20 ✓✓ Day 40 (revision)
